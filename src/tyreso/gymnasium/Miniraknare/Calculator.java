...
public class Calculator {
    ...
    public int multiplication(int tal1, int tal2) {
        int resultat = tal1 * tal2;
    ...
    // Skapar Arraylisten
    public ArrayList<Integer> multiplication(int tal1, ArrayList<Integer> integers) {

        ArrayList<Integer> integerAnswer = new ArrayList<>();
        for (Integer i : integers) {
            integerAnswer.add(i * tal1);
        }
        for (Integer i : integerAnswer){
    ...
    public int divided(int tal1, int tal2) {
        int resultat = tal1 / tal2;

        return resultat;
    }
    public double raised(double tal1, double tal2) {
        double resultat;
        resultat = Math.pow(tal1, tal2);

        BigInteger siffra = new BigInteger("19285641287", 8);
        return resultat;
    }
}
